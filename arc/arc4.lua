-- arc4.lua - Horizon arc + weather panel + moon phase + sun/moon markers + planets
-- v2.0 2026-05-21 @rew62  data access via owm_get() / owm_fetch.lua; drops read_field/read_parsed/jq
